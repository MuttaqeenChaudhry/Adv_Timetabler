...
if(isset($_POST['t23']))
{
    ...
    $Superquery = " SELECT * FROM admin_credentials WHERE admin_id = '$username' && admin_pass = '$password'";
    $Superresult = mysqli_query($con,$Superquery);

    if(mysqli_num_rows($Superresult) > 0)
    {
           session_start();
           $row = mysqli_fetch_array($Superresult);
...
<div class="hero">
    <div class="topnav">
      ...
      <a class="navbartitle">Super User Login</a>
    </div>
 <div class="login-page">
   <div class="form">
     <form action="" method="POST">
      <h1 style = "color: #f2f2f2;">Login</h1>
      <p style="color: #fff;">Username<input type="text" name="username" placeholder="username" required/></p>
      <p style="color: #fff;">Password<input type="password"  name="password" placeholder="password" required/></p>
