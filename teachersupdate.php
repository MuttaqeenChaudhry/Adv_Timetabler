...
<div class="topnav">
            ...
            <a href="teachersupdate.php">Teachers</a>
...
<fieldset>
  ...
  <br><br>
   ...
   border: 2px solid  rgba(44, 130, 201, 1); border-radius:3px;  background:transparent;"  required>
  <br><br>
   <input type="text" name="type" placeholder=" Enter Department"  style="width:100%;height:30px;
   border: 2px solid  rgba(44, 130, 201, 1); border-radius:3px;  background:transparent;"  required>
  <br><br>
  ...
  <br><br>
  <input type="number" name="cost" placeholder=" Enter No"  style="width:100%;height:30px;
