...
<div class="topnav">
            ...
            <a href="customer.php">Phone Numbers</a>
...
<fieldset>  
   <input type="text" name="id" placeholder="Enter ID(cs03-cs05" style="width:100%;height:30px;
...
$sql = "INSERT INTO phone( cs_id,cs_phone) VALUES ('$id','$cs_phone')";
echo $sql;
