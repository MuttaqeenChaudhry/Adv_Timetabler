...
border: 3px solid  #b40a70;background-color: #8d2663;color:#f2f2f2;font-size:15px;" formaction="notificationsadd.php">New Notification</button>
<button   style=" height: 50px;margin-left: 20px;;width: 150px;cursor:pointer;border-radius:15px;
border: 3px solid  #b40a70;background-color: #8d2663;color:#f2f2f2;font-size:15px;" formaction="notificationsupdate.php">Update Notification</button>
