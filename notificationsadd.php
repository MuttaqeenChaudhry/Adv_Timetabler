...
<div class="topnav">
            ...
            <a href="customer.php">New Notification</a>
...
<form method="post" action="notificationsadd.php"> 
<fieldset> 
  ...
  <br><br>
 <input type="text" name="fname" placeholder="Notification Title" style="width:100%;height:30px;
    border: 2px solid #b40a70; border-radius:5px; background:transparent;" required>
  <br><br>
...
if ($conn->query($sql) == TRUE) {
  echo'<div>
  <h1 style="color:#f2f2f2;font-size:20px; font-family: "Roboto", sans-serif;margin:auto;">New Notification of ID='
